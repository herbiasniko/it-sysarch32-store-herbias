...
const stripePromise = loadStripe('pk_test_51PF6IoFftbvOfYAcSAuVRTrncOmz3HrUzDjAleRMNaee78uJFP97msW3AIuI1aMPwhopK28WjetHbPBHxXIhLSTX00tANCw2XO'); 
  ...
  return (
    <div>
      ...
      <div>
        ...
        <button onClick={()=>handleClick(product.product_name,product.product_price, product.product_price*100)}>Checkout</button>
